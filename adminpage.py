...
def create_approval_status(engine):
    ...
    reg_date = date(
        keyboardInput("Year: ", int, "Year of Registration must be Integer"),
        keyboardInput("Month: ", int, "Month of Registration must be Integer"),
        keyboardInput("Day: ", int, "Day of Registration must be Integer"))
